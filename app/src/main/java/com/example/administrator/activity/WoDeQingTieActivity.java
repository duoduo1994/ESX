...
public class WoDeQingTieActivity extends Activity {
...
//		}
		...
		findViewById(R.id.btn_back).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				WoDeQingTieActivity.this.finish();
				}
			}
		});
		iv = (ImageView) findViewById(R.id.iv_more);
	...
	private void initDatas() {
		...
		XUtilsHelper xUtilsHelper1 = new XUtilsHelper(this,"InvitationCard.ashx?Action=GetICardsOrderID",1);
		...
		Observable.create(new Observable.OnSubscribe<String>() {
			...
			public void onError(Throwable e) {
				Toast.makeText(WoDeQingTieActivity.this,
...
//		SmartFruitsRestClient.get("InvitationCard.ashx?Action=GetICardsOrderID", p,
