...
import com.example.administrator.entity.IDCard;
...
import com.example.administrator.utils.Savefile;
import com.lidroid.xutils.http.client.multipart.MultipartEntity;
import com.lidroid.xutils.http.client.multipart.content.FileBody;
import com.lidroid.xutils.view.annotation.ViewInject;

public class ChuShiJiaMeng extends BaseActivity implements OnClickListener {
	...
	@ViewInject(R.id.sfzzm)
	private ImageView sfzzm; // 照片显示
	@ViewInject(R.id.sfzfm)
	...
	@ViewInject(R.id.chushi_jiameng_yemian_scrollview)
	...
	protected int setContentView() {
		return R.layout.chushijiamengsahngchuan;
	}
...
@ViewInject(R.id.iv_more)
	...
	private String appServer="http://120.27.141.95:8086/ashx/";
