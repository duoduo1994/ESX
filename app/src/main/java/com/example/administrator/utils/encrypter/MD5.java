...
public class MD5 {
	 ...
	 * @return
	 */
	public static byte[] getMD5Bytes(String ursourcece)
	{
		try {
			return getMD5Bytes(ursourcece.getBytes("UTF-8"));
...
//	{
//		String s="KJ_1240390070421MAP_1.0";
//		byte[] bytes=MD5.getMD5Bytes(s);
