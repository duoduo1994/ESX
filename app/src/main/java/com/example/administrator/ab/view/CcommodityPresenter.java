...
public class CcommodityPresenter implements View.OnClickListener {
    ...
    public void showDialog(String chanpingdanjia) {
...
//                .displayImage((strUrl), ivShopPhoto, Load.options);
        ...
        switch (v.getId()) {
            case R.id.btn_add:
                ...
                if (tag != null && tag instanceof Integer) { //解决问题：如何知道你点击的按钮是哪一个列表项中的，通过Tag的position
                    ...
                    int danjia=datas.get(position).getDanjia();
                    num++;
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int arg0, View arg1, ViewGroup arg2) {
            ...
            v.tv_peicai.setText(products.get(arg0).getName());
