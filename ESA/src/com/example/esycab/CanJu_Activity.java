...
import com.example.esycab.Fragment.CanJuFragment;
...
public class CanJu_Activity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		yuYue = (LinearLayout) findViewById(R.id.canju_syuyue);
		t1 = (TextView) yuYue.findViewById(R.id.tongyong_jiage);
		t1.setText("租赁费");
		t2 = (TextView) yuYue.findViewById(R.id.unit_price);
		b1 = (Button) yuYue.findViewById(R.id.jiarudingdan);
		b1.setText("加入订单");
		b1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (!new LoginCheckAlertDialogUtils(CanJu_Activity.this,0)
						.showDialog()) {
					shangChuan();
				}
