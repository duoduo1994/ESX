...
public class CookActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		tv.setText("厨师");
		lv1 = (ListView) findViewById(R.id.chushi_xingxi);
		lv1.setSelector(new ColorDrawable(Color.parseColor("#c5c4c3")));
		xingJiS = (Spinner) findViewById(R.id.chushi_xingjis);
		leiBieS = (Spinner) findViewById(R.id.chushi_leibies);
		CSJiaGe = (Button) findViewById(R.id.chushi_chushijiage);
