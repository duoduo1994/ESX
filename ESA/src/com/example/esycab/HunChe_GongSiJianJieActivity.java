...
public class HunChe_GongSiJianJieActivity extends Activity {
	private TextView tv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_hun_che__gong_si_jian_jie);
		...
		findViewById(R.id.btn_back).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (System.currentTimeMillis() - HomeActivity.dianJiShiJian > 500) {
					...
					HunChe_GongSiJianJieActivity.this.finish();
				}
			}
		});
		setMoreListener();
