...
public class WeddinghallActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv1 = (TextView) findViewById(R.id.netName);
		tv2 = (TextView) findViewById(R.id.address);
		tv3 = (TextView) findViewById(R.id.trafficInfo);
		tv4 = (TextView) findViewById(R.id.trafficInfoss);
		tv = (TextView) findViewById(R.id.tv_title);
		tv.setText("喜事堂");
		im = (ImageView) findViewById(R.id.xishitangimage);
		mDistrictSpinner = (Spinner) findViewById(R.id.spin_district);
		mTownSpinner = (Spinner) findViewById(R.id.spin_town);
		mVilleageSpinner = (Spinner) findViewById(R.id.spin_villeage);
		...
		queren = (Button) findViewById(R.id.querenxst);
...
//			fuZhi = (TextView) v.findViewById(R.id.fuzhi_jiantieban);
	...
	public void showXishitang(final String hallId) {
		...
		dialog.showDialog();
		ll = (LinearLayout) findViewById(R.id.xishitang);
	...
	private void setNth(final NTH_Halls nth_Halls) {
		btn_Map = (Button) findViewById(R.id.surrounding_Age);
		...
		dateBtn = (Button) findViewById(R.id.dateBt);
