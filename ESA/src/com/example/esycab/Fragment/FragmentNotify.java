...
import com.example.esycab.MainActivity;
...
import com.example.esycab.WoDeDingDanActivity;
import com.example.esycab.WoDeQingTieAllActivity;
import com.example.esycab.WoDeZhiFuActivity;
...
private boolean isLog = false;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (!HomeActivity.quan) {
			...
			android.widget.LinearLayout.LayoutParams l = (android.widget.LinearLayout.LayoutParams) rl
					.getLayoutParams();
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case 123:
			...
			if (!result.equals("亲，该咋称呼您~")) {
				...
				logon.setText("登录");
				imageView1.setImageResource(R.drawable.myphoto);
			}
