...
import com.example.esycab.CanJu_Activity;
import com.example.esycab.CaseActivity;
import com.example.esycab.ChouJiangShouYe;
import com.example.esycab.HomeActivity;
import com.example.esycab.HunCheActivity;
import com.example.esycab.HunQing;
import com.example.esycab.JiaMengActivity;
import com.example.esycab.R;
import com.example.esycab.ReserveActivity;
import com.example.esycab.WeddinghallActivity;
import com.example.esycab.XiYan;
...
import com.example.esycab.utils.ElasticScrollView;
import com.example.esycab.utils.ElasticScrollView.OnRefreshListener;
...
public class FragmentHome extends Fragment {
	...
	/** 首页轮播的界面的资源 */
	private int[] resId = { R.drawable.shouye6, R.drawable.shouye1,
			R.drawable.shouye2, R.drawable.shouye3, R.drawable.shouye4,
			R.drawable.shouye5, R.drawable.shouye6, R.drawable.shouye1 };
	// 底部小店图片
	...
	private class MyAdapter extends BaseAdapter {
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			if (arg1 == null) {
				...
				android.widget.LinearLayout.LayoutParams pa = (android.widget.LinearLayout.LayoutParams) ll
						.getLayoutParams();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = LayoutInflater.from(HomeActivity._instance).inflate(
				R.layout.sss, null);
		...
		android.widget.LinearLayout.LayoutParams p = (android.widget.LinearLayout.LayoutParams) lv
				.getLayoutParams();
		...
		System.out.println("asdlkfjwoaefj次蛋蛋");
		...
		iv1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				if (!new LoginCheckAlertDialogUtils(HomeActivity._instance,0)
						.showDialog()) {
					isF = false;
	...
	private void initView(View view) {
		...
		vpa = new com.example.esycab.utils.encrypter.ViewPagerAdapter(ali,
	...
	private com.example.esycab.utils.encrypter.ViewPagerAdapter vpa;
	...
	private void setImageBackground(int selectItems) {
		for (int i = 0; i < tips.length; i++) {
			if (i == selectItems) {
				tips[i].setBackgroundResource(R.drawable.red_point);
			} else {
				tips[i].setBackgroundResource(R.drawable.dot_unselected);
			}
		}
	}
